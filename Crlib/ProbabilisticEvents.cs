...
namespace REVUnit.Crlib
{
    ...
    {
        /// <summary>
        ///     此方法有 <paramref name="probability" /> 的概率返回 <c>true</c>，使用 <see cref="Random" /> 类。
        /// </summary>
        public static bool BooleanTrue(float probability)
        {
            var random = new Random();
            return BooleanTrue(probability, random.Next);
        }
        ...
        /// </summary>
        public static bool BooleanTrue(float probability, Func<int, int, int> randomGenerator)
        {
